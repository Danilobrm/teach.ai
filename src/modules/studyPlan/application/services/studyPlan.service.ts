...
export class StudyPlanService {
  ...
  async create(
    studyPlanPerDay: IStudyPlanPerDay[],
  ): Promise<IStudyPlanPerDay[]> {
    return studyPlanPerDay;
    // return this.studyPlanRepo.create(studyPlanPerDay); // Directly passing the studyPlan object
  }
